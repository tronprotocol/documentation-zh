...
SOURCE_ROOT = "https://raw.githubusercontent.com/tronprotocol/documentation-zh/master/docs/"
...
def nav_documents(items: list[object], top_section: str | None = None):
    ...
    for item in items:
        if isinstance(item, str):
            if item.endswith(".md"):
                yield Path(item), top_section or "其它"
            continue
...
def build_manifest() -> dict[str, object]:
    ...
    return {
        "schema_version": 1,
        "project": "java-tron 中文文档",
        "language": "zh-CN",
        "site_url": SITE_URL,
        "source_repository": "https://github.com/tronprotocol/documentation-zh",

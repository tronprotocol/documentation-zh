...
按区块 hash + 块内 index 查询交易。

- 源码：`framework/src/main/java/org/tron/core/services/jsonrpc/TronJsonRpcImpl.java#getTransactionByBlockHashAndIndex`
...
| 位置 | 类型 | 必填 | 说明 |
|---|---|---|---|
| `params[0]` | string | 是 | 区块 hash |
| `params[1]` | string | 是 | 块内交易下标，hex 编码（`0x0` 起） |

...
4.0 版已实现匿名 TRC20 合约，可以隐藏源地址、目标地址和 TRC20 token 交易数额，并为用户提供更好的隐私性。 匿名 TRC20 合约包含三种类型的交易：
...
- [TIP-135](https://github.com/tronprotocol/tips/blob/master/tip-135.md): 匿名 TRC20 合约标准，保证 TRC20 token 匿名转账的隐私性。
